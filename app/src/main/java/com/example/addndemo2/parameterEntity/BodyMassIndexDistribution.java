...
/**
 * Body Mass Index Distribution parameter entity.
 * Including the lines and points and rectangles for the BMI chart.
 */
public class BodyMassIndexDistribution implements Serializable {
	...
	/**
	 * Constructor for BMI distribution.
	 * @param min
	 * @param max
	 * @param mean
	...
	/**
	 * Creating all the point for the BMI chart.
	 *
	 * @return Point List.
	 */
	...
	/**
	 * Creating all the Lines for the BMI chart.
	 *
	 * @return line list.
	 */
	...
	/**
	 * Creating all the rectangle for the BMI chart.
	 *
	...
	public List<Rectangle> getRectangle()
	{
		...
		List<Point> points = new ArrayList<Point>();
		float maxAxisY = max;
		//Creating a list of points by the BMI parameters.
		...
		//Sorting the points that created by the BMI parameters with bubble sort algorithm.
